...
//localStorage.removeItem("nublacklist");
	...
	function main() {
		...
		function displayUserArea() {
			...
			document.addEventListener('DOMNodeInserted', function(event) {
				var $users = $(event.target).find('a.p_author_name.j_user_card');
		...
		function saveConfig() {
			...
			//黑名单
			{
				...
				localStorage["nublacklist"] = JSON.stringify(blacklist);
			}
